...
Data:
  ...
  news, news-unanalyzed, news-analyzed, news-analyze, technicals, levels
  levels-refresh, sectors, sync-transactions
...
case "$CMD" in
  ...
  # Data
  refresh|backfill|snapshot|snapshot-history|snapshot-position|news|news-unanalyzed|news-analyzed|news-analyze|technicals|levels|levels-refresh|sectors|sync-transactions)
