...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { path: '/broker-pl', label: 'Broker P&L', icon: PLIcon },
    ],
  },
  {
    label: 'Governance',
    ...
    items: [
      ...
      { path: '/news-analysis', label: 'News Analysis', icon: NewsAnalysisIcon },
      { path: '/thesis-review', label: 'Thesis Review', icon: ThesisReviewIcon },
      { path: '/post-mortems', label: 'Post-Mortems', icon: PostMortemIcon },
      { path: '/earnings-reviews', label: 'Earnings Reviews', icon: EarningsIcon },
    ],
  },
  {
    label: 'Execution',
    ...
    items: [
      ...
      { path: '/ems', label: 'EMS Baskets', icon: EmsIcon },
      { path: '/active-management', label: 'Active Mgmt', icon: ActiveMgmtIcon },
      { path: '/tax-lots', label: 'Tax Lots', icon: TaxIcon },
    ],
  },
  {
    label: 'Admin',
...
export default function Layout({ children }: LayoutProps) {
  const [openSections, setOpenSections] = useState<Record<string, boolean>>(() => {
    ...
    navSections.forEach(s => { initial[s.label] = s.defaultOpen; });
    return initial;
  });
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500 mt-1">Personal Investment Tracker</p>
        </div>
...
// Chevron icon for section toggle
function ChevronIcon({ className, open }: { className?: string; open: boolean }) {
  return (
    <svg
      className={`${className} transform transition-transform ${open ? 'rotate-0' : '-rotate-90'}`}
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
...
function PostMortemIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function EmsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function PLIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function ThesisReviewIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function NewsAnalysisIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
